...
export default function newsletter(){
    return (
        <section className="bg-gray-50 mt-20">
            <div className="containter mx-auto md:px-20 py-16 text-center">
            ...
            <button className="bg-orange-400 py-3 px-20 rounded-full text-gray-50 text-xl">Subscribe</button>
